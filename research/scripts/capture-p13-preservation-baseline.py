...
def main() -> None:
    ...
    if args.check:
        if not BASELINE.exists() or not trusted.preservation_baseline_matches(json.loads(BASELINE.read_text(encoding="utf-8")),observed): raise SystemExit("P13_BASELINE_CHECK_FAILED: Package 001-012 bytes/state drift")
