...
def main()->None:
    ...
    if args.check:
        if not BASELINE.exists() or json.loads(BASELINE.read_text(encoding="utf-8"))!=observed: raise SystemExit("P15_BASELINE_CHECK_FAILED: Package 001-014 bytes/state drift")
