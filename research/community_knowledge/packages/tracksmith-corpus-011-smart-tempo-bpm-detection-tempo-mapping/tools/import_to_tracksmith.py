...
def main():
 ...
 proj=projection(); packages_root=target/'research/community_knowledge/packages'; dest=packages_root/M['package_id']; runtime=target/'research/community_knowledge/runtime/pkg011_smart_tempo_bpm_detection_tempo_mapping.runtime.jsonl'
