...
def main():
 ...
 proj=projection(); packages_root=target/'research/community_knowledge/packages'; dest=packages_root/M['package_id']; runtime=target/'research/community_knowledge/runtime/pkg014_sidechain_automation_midi_groove_velocity_transform.runtime.jsonl'
