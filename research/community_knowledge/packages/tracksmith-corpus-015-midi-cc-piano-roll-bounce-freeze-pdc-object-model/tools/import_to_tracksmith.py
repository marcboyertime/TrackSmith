...
def main():
 ...
 proj=projection(); packages_root=target/'research/community_knowledge/packages'; dest=packages_root/M['package_id']; runtime=target/'research/community_knowledge/runtime/pkg015_midi_cc_piano_roll_bounce_freeze_pdc_object_model.runtime.jsonl'
