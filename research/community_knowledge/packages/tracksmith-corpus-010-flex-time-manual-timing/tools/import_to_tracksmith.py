...
def main():
 ...
 proj=projection(); packages_root=target/'research/community_knowledge/packages'; dest=packages_root/M['package_id']; runtime=target/'research/community_knowledge/runtime/pkg010_flex_time_manual_timing.runtime.jsonl'
