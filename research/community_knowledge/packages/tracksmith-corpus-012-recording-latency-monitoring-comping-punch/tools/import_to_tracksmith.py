...
def main():
 ...
 proj=projection(); packages_root=target/'research/community_knowledge/packages'; dest=packages_root/M['package_id']; runtime=target/'research/community_knowledge/runtime/pkg012_recording_latency_monitoring_comping_punch.runtime.jsonl'
