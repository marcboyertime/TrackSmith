...
public struct GeneralTutorRouter: Sendable {
    ...
    private static let domainCues: [(ProductionDomain, [String])] = [
        ...
        (.performanceCapture, ["record", "recording", "tracking", "take", "performance", "re-record", "repair it later", "before tracking"]),
        (.latency, ["latency", "delay when i play", "monitoring delay", "buffer"]),
        (.noise, ["noise", "hiss", "hum", "buzz", "background noise", "noise floor"]),
        ...
        (.velocity, ["velocity", "velocities", "too loud notes", "note dynamics"]),
        (.noteLength, ["note length", "note lengths", "legato", "staccato"]),
        (.sustainPedal, ["sustain pedal", "pedal", "cc64"]),
        (.tempoMapping, ["tempo map", "tempo mapping", "beat mapping", "smart tempo", "tempo follow"]),
        (.rubato, ["rubato", "expressive timing", "free time", "breathe"]),
        (.handIndependence, ["left hand", "right hand", "both hands"]),
        (.humanization, ["humanize", "humanise", "robotic", "mechanical", "too perfect"]),
        ...
        (.compression, ["compress", "compression", "compressor", "threshold", "ratio", "attack", "release", "makeup gain"]),
        ...
        (.stereoImaging, ["stereo", "wide", "wider", "width", "imaging", "pan", "panning"]),
        (.limiting, ["limiter", "limiting", "ceiling", "true peak", "distorting on the loud", "loud parts"]),
        (.metering, ["meter", "metering", "lufs", "rms", "peak meter"]),

        (.reverb, ["reverb", "verb", "chromaverb", "space designer", "room sound", "hall", "plate"]),
        ...
        (.depth, ["depth", "far away", "distant", "close", "closer", "intimate", "in your face", "front to back", "disappear", "disappears", "pushed back", "too far back"]),
        ...
        (.mixDepth, ["create depth", "depth in a mix", "depth in the mix", "front to back in the mix"]),
        (.intros, ["intro", "intros", "opening", "pulls people in"]),
        (.headphonesVersusMonitors, ["headphones or monitors", "headphones versus monitors", "on headphones", "on monitors"]),
        (.peaks, ["peaks", "peaking", "distorting on the loud", "clipping the master"]),
        (.contrast, ["feels the same", "same all the way through", "no contrast"]),
        (.density, ["density", "busy", "crowded", "cluttered", "too much going on", "sparse", "feels the same", "same all the way", "nothing stands out"]),
        ...
        (.registerAllocation, ["register", "frequency range", "space for each", "fighting for the same"]),
        (.orchestration, ["arrangement", "arrange", "orchestration", "instrumentation", "parts"]),

        (.balance, ["balance", "too loud in the mix", "buried", "not cutting through", "sits behind", "sit under", "sit behind", "nothing stands out", "stands out"]),
        (.masking, ["masking", "masked", "muddy together", "fighting", "clashing", "work together", "sit under", "sit behind", "no weight"]),
        (.tonalDistribution, ["tonal balance", "too bright", "too dark", "dull", "muddy", "boomy", "thin", "harsh", "boxy"]),
        (.translation, ["translate", "translation", "sounds different in the car", "different on speakers"]),
        ...
        (.loudness, ["loudness", "lufs", "streaming level", "how loud"]),
        (.formatAndExport, ["export", "bounce", "render", "file format", "wav", "mp3"]),
        (.streamingDelivery, ["spotify", "apple music", "streaming", "normalization"]),

        (.listeningLevel, ["listening level", "monitor level", "loud when i turn it up", "quiet listening"]),
        (.earFatigue, ["ear fatigue", "ears tired", "fatiguing", "ears get tired", "after an hour"]),
        (.comparisonBias, ["louder sounds better", "bias", "level matched", "level matching", "listen for when comparing", "when comparing"]),
        (.references, ["reference track", "use a reference", "reference properly", "against a reference", "comparing two masters", "two masters"]),

        (.logicTools, ["logic tool", "tool menu", "marquee", "scissors", "flex tool"]),
        ...
        (.comparingApproaches, ["should i use", "or should i", "which is better", "versus", " vs "]),
        (.knowingWhenToStop, ["when do i stop", "when should i stop", "how do i know when"]),
